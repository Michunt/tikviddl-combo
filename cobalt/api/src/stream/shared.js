...
export function getHeaders(service, additionalHeaders = {}) {
    // Converting all header values to strings
    let headers = { ...defaultHeaders, ...serviceHeaders[service] };
    
    // Add any additional headers (like cookies from services)
